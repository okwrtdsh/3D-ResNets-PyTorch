...
from .binarized_modules import ExposurefContinuous
...
class C2DPtExpC(nn.Module):
    ...
    def __init__(self,
        ...
        self.exp = ExposurefContinuous(t=sample_duration, c=1, s=8, binarize_type=binarize_type)
